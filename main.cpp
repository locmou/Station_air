...
byte soleil[8][8] = {
  {0x11, 0x08, 0x04, 0x02, 0x00, 0x00, 0x00, 0x1E}, // 0
  {0x01, 0x00, 0x07, 0x08, 0x10, 0x10, 0x10, 0x10}, // 1
  {0x00, 0x00, 0x1C, 0x02, 0x01, 0x01, 0x01, 0x01}, // 2
  {0x11, 0x02, 0x04, 0x08, 0x00, 0x00, 0x00, 0x0F}, // 3
  {0x00, 0x02, 0x04, 0x08, 0x10, 0x01, 0x02, 0x04}, // 4
  {0x10, 0x10, 0x08, 0x07, 0x00, 0x01, 0x01, 0x01}, // 5
  {0x01, 0x01, 0x02, 0x1C, 0x00, 0x01, 0x00, 0x01}, // 6
  {0x00, 0x08, 0x04, 0x02, 0x01, 0x10, 0x08, 0x04}  // 7
};
...
byte nuageSoleil[8][8] = {
  {0x00, 0x00, 0x03, 0x07, 0x0F, 0x0F, 0x0F, 0x0F}, // 0: Bordure gauche nuage
  {0x01, 0x00, 0x1C, 0x1C, 0x1C, 0x1F, 0x1F, 0x1F}, // 1: Cœur du nuage
  {0x02, 0x00, 0x10, 0x0F, 0x10, 0x18, 0x1C, 0x00}, // 2: Transition
  {0x04, 0x08, 0x10, 0x00, 0x10, 0x10, 0x17, 0x10}, // 3: Rayons haut
  {0x1F, 0x1F, 0x1F, 0x0F, 0x07, 0x00, 0x00, 0x00}, // 4: Base nuage
  {0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x00, 0x00, 0x00}, // 5: Base nuage (suite)
  {0x1C, 0x1F, 0x1C, 0x1C, 0x1A, 0x02, 0x02, 0x02}, // 6: Rayons bas
